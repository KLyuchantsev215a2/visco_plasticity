program base
    ...
    real*8 :: nu,mu,cs_0,E,k,eta,damping,friction !material constants
   ...
   Ci(1:2,1:2,1:N)=Ci_new(1:2,1:2,1:N)
    ...
    do step=1,int(T/dt)
        x_0=x
        v_0_0=v
        call Compute_Acceleration(N,h,dh,rho_0,mu,k,eta,damping,vol,F,Couchy,PK1,x_0,x_init,v,nabla_W_0,nabla_W,W,Wper1,Wper2,Wper3,Wper4,acc,count_hole,count_section,index_section,index_hole,Ci,Ci_new,table,friction)
        v=v+dt*acc
        x=x+dt*v
